...
Possuo forte atuação no ecossistema **.NET**, com sólida experiência em **C#** e no desenvolvimento de arquiteturas modernas baseadas em **microserviços** e **comunicação assíncrona** utilizando **RabbitMQ** e **Kafka**.

Atuo na construção de aplicações **cloud-ready**, utilizando **Docker**, **testes automatizados** e práticas de engenharia que garantem **confiabilidade**, **observabilidade** e **evolução sustentável** dos sistemas.

Ao longo da minha carreira, aplico princípios como **Clean Architecture**, **SOLID**, **KISS** e **DRY** para desenvolver soluções robustas e preparadas para **ambientes de produção**.
...
Estou sempre aberto a trocar experiências, discutir tecnologia e colaborar em projetos desafiadores.

Se quiser conversar sobre engenharia de software, arquitetura ou oportunidades, será um prazer falar com você.
...
<p align="center">
Construindo software com qualidade, propósito e visão de longo prazo. ❤️
</p>
